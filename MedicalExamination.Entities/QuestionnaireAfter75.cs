...
{
    public sealed class QuestionnaireAfter75
    {
        [Key]
        ...
        public bool QuestionOneTwoOne { get; set; }

        public bool QuestionOneThree { get; set; }
        public string QuestionOneThreeOne { get; set; }

        public bool QuestionOneFour { get; set; }
        public bool QuestionOneFourOne { get; set; }
        ...
        public bool QuestionTwenty { get; set; }
